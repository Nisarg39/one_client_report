...
export interface ChatSidebarProps {
  ...
  onCreateClient?: () => void; // DEPRECATED: Auto-workspace creation handles this now
    ...
    <aside className="w-[22rem] bg-[#1a1a1a] flex flex-col h-full border-r-2 border-gray-800/50 shadow-[10px_0_30px_rgba(0,0,0,0.95)]">
      ...
      <div className="p-4 border-b border-gray-800/50">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-12 h-12 rounded-2xl bg-[#1a1a1a] shadow-neu-raised flex items-center justify-center border border-white/5 group overflow-hidden relative">
            ...
            <Bot className="w-6 h-6 text-[#6CA3A2] relative z-10" />
          </div>
          <div>
            <h2
              className="text-xl font-black text-[#f5f5f5] uppercase tracking-tighter"
            >
              One<span className="text-[#6CA3A2]">Assist</span>
            </h2>
            <div className="flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-[#6CA3A2] animate-pulse" />
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#999999]">System Online</p>
            </div>
          </div>
        </div>
        ...
        {onViewModeChange && (
          <div className="flex bg-[#1a1a1a] rounded-2xl p-1.5 shadow-neu-inset border border-white/5">
            <button
              onClick={() => onViewModeChange('chat')}
              className={`flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl transition-all duration-300 ${viewMode === 'chat'
                ? 'bg-[#6CA3A2] text-white shadow-neu-raised'
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl transition-all duration-300 ${viewMode === 'dashboard'
                ? 'bg-[#6CA3A2] text-white shadow-neu-raised'
                : 'text-[#888888] hover:text-[#c0c0c0]'
                }`}
            >
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4 space-y-4">
          ...
          {viewMode === 'dashboard' && onDashboardSectionChange && (
            <div className="space-y-2">
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 ${dashboardSection === 'overview'
              ...
              {canManageMultipleWorkspaces && (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 ${dashboardSection === 'clients'
                    ? 'bg-[#252525] text-[#6CA3A2] shadow-[inset_4px_4px_8px_rgba(0,0,0,0.6),inset_-4px_-4px_8px_rgba(60,60,60,0.2)]'
                    : 'bg-[#1a1a1a] text-[#c0c0c0] shadow-[-4px_-4px_12px_rgba(60,60,60,0.4),4px_4px_12px_rgba(0,0,0,0.8)] hover:shadow-[-2px_-2px_8px_rgba(60,60,60,0.4),2px_2px_8px_rgba(0,0,0,0.8)]'
                    }`}
                >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 ${dashboardSection === 'profile'
                  ? 'bg-[#252525] text-[#6CA3A2] shadow-[inset_4px_4px_8px_rgba(0,0,0,0.6),inset_-4px_-4px_8px_rgba(60,60,60,0.2)]'
                  : 'bg-[#1a1a1a] text-[#c0c0c0] shadow-[-4px_-4px_12px_rgba(60,60,60,0.4),4px_4px_12px_rgba(0,0,0,0.8)] hover:shadow-[-2px_-2px_8px_rgba(60,60,60,0.4),2px_2px_8px_rgba(0,0,0,0.8)]'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 ${dashboardSection === 'settings'
                  ? 'bg-[#252525] text-[#6CA3A2] shadow-[inset_4px_4px_8px_rgba(0,0,0,0.6),inset_-4px_-4px_8px_rgba(60,60,60,0.2)]'
                  : 'bg-[#1a1a1a] text-[#c0c0c0] shadow-[-4px_-4px_12px_rgba(60,60,60,0.4),4px_4px_12px_rgba(0,0,0,0.8)] hover:shadow-[-2px_-2px_8px_rgba(60,60,60,0.4),2px_2px_8px_rgba(0,0,0,0.8)]'
                  }`}
              >
          ...
          {viewMode === 'chat' && (
            <>
              {/* Client Selector Dropdown - Only show for Agency/Enterprise plans */}
              {canManageMultipleWorkspaces && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {/* HIDDEN: Create new client button - users now get auto-created workspace on signup
                    <button
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {/* Dropdown Icon */}
                      <ChevronDown
                        className={`w-4 h-4 text-[#6CA3A2] transition-transform flex-shrink-0 ${isDropdownOpen ? 'rotate-180' : ''
                          }`}
                      />
                    </button>
                    ...
                    conversations.map((conversation) => {
                      ...
                      return (
                        <div
                          ...
                          className={`relative group flex items-start gap-2 px-3 py-2.5 rounded-lg transition-all duration-200 ${isActive
                        ...
                        >
                          ...
                          >
                            ...
                            {conversation.isPinned ? (
                              ...
                              <MessageSquare
                                className={`w-4 h-4 mt-0.5 flex-shrink-0 ${isActive ? 'text-[#6CA3A2]' : 'text-[#808080]'
                                  }`}
                              />
                            )}
                            <div className="flex-1 min-w-0">
                              <p
                                className={`text-xs truncate ${isActive ? 'text-[#f5f5f5]' : 'text-[#c0c0c0]'
                                  }`}
                                style={{ textShadow: '0 1px 2px rgba(0,0,0,0.5)' }}
                              >
            ...
            <div className="flex items-center gap-3 px-3 py-2.5 bg-[#1a1a1a] rounded-xl shadow-[inset_2px_2px_6px_rgba(0,0,0,0.6),inset_-2px_-2px_6px_rgba(60,60,60,0.2)]">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <Badge
                    variant="outline"
                    className={`text-[10px] px-1.5 py-0 border-opacity-30 ${user.usageTier === 'student' ? 'bg-blue-500/10 text-blue-300 border-blue-500' :
                      user.subscriptionStatus === 'active' ? 'bg-amber-500/10 text-amber-300 border-amber-500' :
                        user.subscriptionStatus === 'trial' ? 'bg-purple-500/10 text-purple-300 border-purple-500' :
                          'bg-red-500/10 text-red-300 border-red-500'
                      }`}
                  >
                    {user.usageTier === 'student' ? 'Student' :
                      user.subscriptionStatus === 'trial' ? 'Trial' :
                        user.subscriptionStatus === 'active' ? user.usageTier?.toUpperCase() || 'PRO' :
                          'Expired'}
                  </Badge>

                  <button
                    onClick={() => window.open('/dashboard/subscription', '_blank')}
                    className="text-[10px] text-[#6CA3A2] hover:text-[#5a9291] underline decoration-[#6CA3A2]/30 hover:decoration-[#5a9291]/50 transition-colors"
                  >
                    Manage
                  </button>
                </div>
                  ...
                  <div className="mt-1 flex items-center gap-1.5">
                    {(() => {
                      ...
                      if (diffDays <= 3 && diffDays > 0) {
                        return (
                          <span className="text-[10px] text-amber-500/90 font-medium" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.5)' }}>
                            ⚠️ Ends in {diffDays} day{diffDays !== 1 ? 's' : ''}
                          </span>
                        );
                      }
                      return null;
